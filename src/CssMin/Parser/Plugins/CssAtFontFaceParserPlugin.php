...
/**
 * {@link AbstractCssParserPlugin Parser plugin} for parsing @font-face at-rule block with including declarations.
 * 
 ...
 * @version		3.0.1
 */
class CssAtFontFaceParserPlugin extends AbstractCssParserPlugin
	{
	/**
