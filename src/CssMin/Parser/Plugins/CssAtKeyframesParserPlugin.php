...
/**
 * {@link AbstractCssParserPlugin Parser plugin} for parsing @keyframes at-rule blocks, rulesets and declarations.
 * 
 ...
 * @version		3.0.1
 */
class CssAtKeyframesParserPlugin extends AbstractCssParserPlugin
	{
	/**
	 * @var string Keyword
	 */
