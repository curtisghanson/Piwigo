...
/**
 * {@link AbstractCssParserPlugin Parser plugin} for parsing @page at-rule block with including declarations.
 * 
 ...
 * @version		3.0.1
 */
class CssAtPageParserPlugin extends AbstractCssParserPlugin
	{
	/**
