...
/**
 * {@link AbstractCssParserPlugin Parser plugin} for parsing @variables at-rule block with including declarations.
 * 
 ...
 * @version		3.0.1
 */
class CssAtVariablesParserPlugin extends AbstractCssParserPlugin
	{
	/**
