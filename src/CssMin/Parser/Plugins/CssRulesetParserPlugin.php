...
/**
 * {@link AbstractCssParserPlugin Parser plugin} for parsing ruleset block with including declarations.
 * 
 ...
 * @version		3.0.1
 */
class CssRulesetParserPlugin extends AbstractCssParserPlugin
	{
	/**
