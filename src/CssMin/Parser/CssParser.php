...
class CssParser
	...
	private $buffer = "";
	/**
	 * {@link AbstractCssParserPlugin Plugins}.
	 * 
	 * @var array
	 */
	 ...
	 * Constructer.
	 * 
	 *  Create instances of the used {@link AbstractCssParserPlugin plugins}.
	 * 
	 ...
	 * 
	 * @param AbstractCssToken $token Token to append
	 * @return void
	 */
	public function appendToken(AbstractCssToken $token)
		{
		$this->tokens[] = $token;
		}
	/**
	 ...
	 * @return AbstractCssParserPlugin
	 */
