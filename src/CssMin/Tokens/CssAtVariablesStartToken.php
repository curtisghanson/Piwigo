...
/**
 * This {@link AbstractCssToken CSS token} represents the start of a @variables at-rule block.
 *
 ...
 * @version		3.0.1
 */
class CssAtVariablesStartToken extends AbstractCssAtBlockStartToken
	{
	/**
