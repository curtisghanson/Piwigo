...
/**
 * This {@link AbstractCssToken CSS token} represents the start of a @keyframes at-rule block.
 *
 ...
 * @version		3.0.1
 */
class CssAtKeyframesStartToken extends AbstractCssAtBlockStartToken
	{
	/**
	 * Name of the at-rule.
	 * 
