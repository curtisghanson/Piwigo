...
use CssMin\Tokens\CssNullToken;
use CssMin\Minifier\Plugins\AbstractCssMinifierPlugin;

/**
 * This {@link AbstractCssMinifierPlugin} will process var-statement and sets the declaration value to the variable value. 
 * 
 ...
 * @version		3.0.1
 */
class CssVariablesMinifierPlugin extends AbstractCssMinifierPlugin
	{
	/**
