<?php
namespace CssMin\Minifier\Plugins;

use CssMin\Minifier\CssMinifier;
use CssMin\Minifier\Plugins\AbstractCssMinifierPlugin;
use CssMin\Tokens\AbstractCssToken;

/**
 * This {@link AbstractCssMinifierPlugin} will convert the font-weight values normal and bold to their numeric notation.
 * 
 * Example:
 * <code>
 * font-weight: normal;
 ...
 * @version		3.0.1
 */
class CssConvertFontWeightMinifierPlugin extends AbstractCssMinifierPlugin
	{
	/**
	...
	/**
	 * Overwrites {@link AbstractCssMinifierPlugin::__construct()}.
	 * 
	...
	/**
	 * Implements {@link AbstractCssMinifierPlugin::minify()}.
	 * 
	 * @param AbstractCssToken $token Token to process
	 * @return boolean Return TRUE to break the processing of this token; FALSE to continue
	 */
	public function apply(AbstractCssToken &$token)
		{
