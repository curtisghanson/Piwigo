...
/**
 * This {@link AbstractCssMinifierPlugin} will compress several unit values to their short notations. Examples:
 * 
 * <code>
 * padding: 0.5em;
 * border: 0px;
 ...
 * @version		3.0.1
 */
class CssCompressUnitValuesMinifierPlugin extends AbstractCssMinifierPlugin
	{
	/**
