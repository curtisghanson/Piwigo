...
/**
 * This {@link AbstractCssMinifierPlugin} compress the content of expresssion() declaration values.
 * 
 ...
 * @version		3.0.1
 */
class CssCompressExpressionValuesMinifierPlugin extends AbstractCssMinifierPlugin
	{
	/**
