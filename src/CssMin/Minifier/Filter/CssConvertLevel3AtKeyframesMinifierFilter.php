<?php
namespace CssMin\Minifier\Filter;

use CssMin\Minifier\Filter\AbstractCssMinifierFilter;

/**
 * This {@link AbstractCssMinifierFilter minifier filter} will convert @keyframes at-rule block to browser specific counterparts.
 * 
 ...
 * @version		3.0.1
 */
class CssConvertLevel3AtKeyframesMinifierFilter extends AbstractCssMinifierFilter
{
/**
 * Implements {@link AbstractCssMinifierFilter::filter()}.
 * 
 * @param array $tokens Array of objects of type AbstractCssToken
