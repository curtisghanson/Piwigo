...
use CssMin\Tokens\CssRulesetDeclarationToken;
 ...
 * @version		3.0.1
 */
class CssConvertLevel3PropertiesMinifierFilter extends AbstractCssMinifierFilter
	{
	/**
